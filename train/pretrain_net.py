...
import importlib
import re
from dataset.iterator import RecordIter
from train.metric import MultiBoxMetric
from evaluate.eval_metric import MApMetric, VOC07MApMetric
from config.config import cfg
from symbol.symbol_factory_pretrain import get_symbol_train
...
def pretrain_net(net, train_path, num_classes, batch_size,
    ...
    train_iter = RecordIter(train_path, batch_size, data_shape, mean_pixels=mean_pixels,
        label_pad_width=label_pad_width, path_imglist=train_list, **cfg.train)

    if val_path:
        val_iter = RecordIter(val_path, batch_size, data_shape, mean_pixels=mean_pixels,
