...
#net = get_symbol_train(model_name, 224, num_classes=1000)
#"""
net = gluon.nn.SymbolBlock.imports('{}_pretrain.json'.format(opt.model),
                                   ['data'],
                                   '{}_pretrain.params'.format(opt.model),
                                   ctx = context)
...
def train(ctx):
    ...
    for epoch in range(opt.num_epochs):
        ...
        print('Total Batch : ', len(train_data))
