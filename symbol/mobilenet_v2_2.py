...
def get_symbol(num_classes, **kwargs):
    ...
    conv1 = mx.symbol.Convolution(name='conv1', data=data , num_filter=int(32 * scale), pad=(1, 1), kernel=(3,3), stride=(2,2), no_bias=True)
    ...
    conv2_1_expand = mx.symbol.Convolution(name='conv2_1_expand', data=relu1 , num_filter=int(32 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv2_1_dwise = mx.symbol.Convolution(name='conv2_1_dwise', data=relu2_1_expand , num_filter=int(32 * scale), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(32 * scale))
    ...
    conv2_1_linear = mx.symbol.Convolution(name='conv2_1_linear', data=relu2_1_dwise , num_filter=int(16 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv2_2_expand = mx.symbol.Convolution(name='conv2_2_expand', data=conv2_1_linear_scale , num_filter=int(96 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv2_2_dwise = mx.symbol.Convolution(name='conv2_2_dwise', data=relu2_2_expand , num_filter=int(96 * scale), pad=(1, 1), kernel=(3,3), stride=(2,2), no_bias=True, num_group=int(96 * scale))
    ...
    conv2_2_linear = mx.symbol.Convolution(name='conv2_2_linear', data=relu2_2_dwise , num_filter=int(24 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv3_1_expand = mx.symbol.Convolution(name='conv3_1_expand', data=conv2_2_linear_scale , num_filter=int(144 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv3_1_dwise = mx.symbol.Convolution(name='conv3_1_dwise', data=relu3_1_expand , num_filter=int(144 * scale),  pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(144 * scale))
    ...
    conv3_1_linear = mx.symbol.Convolution(name='conv3_1_linear', data=relu3_1_dwise , num_filter=int(24 * scale),  pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv3_2_expand = mx.symbol.Convolution(name='conv3_2_expand', data=block_3_1 , num_filter=int(144 * scale),  pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv3_2_dwise = mx.symbol.Convolution(name='conv3_2_dwise', data=relu3_2_expand , num_filter=int(144 * scale) , pad=(1, 1), kernel=(3,3), stride=(2,2), no_bias=True, num_group=int(144 * scale))
    ...
    conv3_2_linear = mx.symbol.Convolution(name='conv3_2_linear', data=relu3_2_dwise , num_filter=int(32 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv4_1_expand = mx.symbol.Convolution(name='conv4_1_expand', data=conv3_2_linear_scale , num_filter=int(192 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv4_1_dwise = mx.symbol.Convolution(name='conv4_1_dwise', data=relu4_1_expand , num_filter=int(192 * scale), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(192 * scale))
    ...
    conv4_1_linear = mx.symbol.Convolution(name='conv4_1_linear', data=relu4_1_dwise , num_filter=int(32 * scale),pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv4_2_expand = mx.symbol.Convolution(name='conv4_2_expand', data=block_4_1 , num_filter=int(192 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv4_2_dwise = mx.symbol.Convolution(name='conv4_2_dwise', data=relu4_2_expand , num_filter=int(192 * scale), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(192 * scale))
    ...
    conv4_2_linear = mx.symbol.Convolution(name='conv4_2_linear', data=relu4_2_dwise , num_filter=int(32 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv4_3_expand = mx.symbol.Convolution(name='conv4_3_expand', data=block_4_2 , num_filter=int(192 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv4_3_dwise = mx.symbol.Convolution(name='conv4_3_dwise', data=relu4_3_expand , num_filter=int(192 * scale), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(192 * scale))
    ...
    conv4_3_linear = mx.symbol.Convolution(name='conv4_3_linear', data=relu4_3_dwise , num_filter=int(64 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv4_4_expand = mx.symbol.Convolution(name='conv4_4_expand', data=conv4_3_linear_scale , num_filter=int(384 * scale),pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv4_4_dwise = mx.symbol.Convolution(name='conv4_4_dwise', data=relu4_4_expand , num_filter=int(384 * scale), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(384 * scale))
    ...
    conv4_4_linear = mx.symbol.Convolution(name='conv4_4_linear', data=relu4_4_dwise , num_filter=int(64 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv4_5_expand = mx.symbol.Convolution(name='conv4_5_expand', data=block_4_4 , num_filter=int(384 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv4_5_dwise = mx.symbol.Convolution(name='conv4_5_dwise', data=relu4_5_expand , num_filter=int(384 * scale), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(384 * scale))
    ...
    conv4_5_linear = mx.symbol.Convolution(name='conv4_5_linear', data=relu4_5_dwise , num_filter=int(64 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv4_6_expand = mx.symbol.Convolution(name='conv4_6_expand', data=block_4_5 , num_filter=int(384 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv4_6_dwise = mx.symbol.Convolution(name='conv4_6_dwise', data=relu4_6_expand , num_filter=int(384 * scale), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(384 * scale))
    ...
    conv4_6_linear = mx.symbol.Convolution(name='conv4_6_linear', data=relu4_6_dwise , num_filter=int(64 * scale),pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv4_7_expand = mx.symbol.Convolution(name='conv4_7_expand', data=block_4_6 , num_filter=int(384 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv4_7_dwise = mx.symbol.Convolution(name='conv4_7_dwise', data=relu4_7_expand , num_filter=int(384 * scale),pad=(1, 1), kernel=(3,3), stride=(2,2), no_bias=True, num_group=int(384 * scale))
    ...
    conv4_7_linear = mx.symbol.Convolution(name='conv4_7_linear', data=relu4_7_dwise , num_filter=int(96 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv5_1_expand = mx.symbol.Convolution(name='conv5_1_expand', data=conv4_7_linear_scale , num_filter=int(576 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv5_1_dwise = mx.symbol.Convolution(name='conv5_1_dwise', data=relu5_1_expand , num_filter=int(576 * scale), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(576 * scale))
    ...
    conv5_1_linear = mx.symbol.Convolution(name='conv5_1_linear', data=relu5_1_dwise , num_filter=int(96 * scale),pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv5_2_expand = mx.symbol.Convolution(name='conv5_2_expand', data=block_5_1 , num_filter=int(576 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv5_2_dwise = mx.symbol.Convolution(name='conv5_2_dwise', data=relu5_2_expand , num_filter=int(576 * scale), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(576 * scale))
    ...
    conv5_2_linear = mx.symbol.Convolution(name='conv5_2_linear', data=relu5_2_dwise , num_filter=int(96 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv5_3_expand = mx.symbol.Convolution(name='conv5_3_expand', data=block_5_2 , num_filter=int(576 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv5_3_dwise = mx.symbol.Convolution(name='conv5_3_dwise', data=relu5_3_expand , num_filter=int(576 * scale), pad=(1, 1), kernel=(3,3), stride=(2,2), no_bias=True, num_group=int(576 * scale))
    ...
    conv5_3_linear = mx.symbol.Convolution(name='conv5_3_linear', data=relu5_3_dwise , num_filter=int(160 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv6_1_expand = mx.symbol.Convolution(name='conv6_1_expand', data=conv5_3_linear_scale , num_filter=int(960 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv6_1_dwise = mx.symbol.Convolution(name='conv6_1_dwise', data=relu6_1_expand , num_filter=int(960 * scale), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(960 * scale))
    ...
    conv6_1_linear = mx.symbol.Convolution(name='conv6_1_linear', data=relu6_1_dwise , num_filter=int(160 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv6_2_expand = mx.symbol.Convolution(name='conv6_2_expand', data=block_6_1 , num_filter=int(960 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv6_2_dwise = mx.symbol.Convolution(name='conv6_2_dwise', data=relu6_2_expand , num_filter=int(960 * scale), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(960 * scale))
    ...
    conv6_2_linear = mx.symbol.Convolution(name='conv6_2_linear', data=relu6_2_dwise , num_filter=int(160 * scale), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv6_3_expand = mx.symbol.Convolution(name='conv6_3_expand', data=block_6_2 , num_filter=int(960 * scale),pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv6_3_dwise = mx.symbol.Convolution(name='conv6_3_dwise', data=relu6_3_expand , num_filter=int(960 * scale), pad=(1, 1), kernel=(3,3), stride=(1,1), no_bias=True, num_group=int(960 * scale))
    ...
    conv6_3_linear = mx.symbol.Convolution(name='conv6_3_linear', data=relu6_3_dwise , num_filter=int(320 * scale),pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
    ...
    conv6_4 = mx.symbol.Convolution(name='conv6_4', data=conv6_3_linear_scale , num_filter=int(1280), pad=(0, 0), kernel=(1,1), stride=(1,1), no_bias=True)
