...
def shuffleUnit(residual, in_channels, out_channels, combine_type, groups = 4, grouped_conv = True, stage = '', repeat = ''):
...
def make_stage(data, stage, groups = 4):
    stage_repeats = [3, 7, 3]
