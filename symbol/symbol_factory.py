...
def get_config(network, data_shape, **kwargs):
    ...
    if network == 'vgg16_reduced':
    ...
    elif network == 'se-resnext50-32x4d':
        from_layers = ['seresx15', 'seresx16', '', '', '', '']
        model = 50
        num_group = 32
        ...
        steps = []
        return locals()
    elif network == 'inceptionv-resnet-v2':
    ...
    elif network == 'inception-v4':
        from_layers = ['in2C_concat', 'in3C_concat', '', '', '', '']
        num_filters = [-1, -1, 512, 256, 256, 128]
        strides = [-1, -1, 2, 2, 2, 2]
        pads = [-1, -1, 1, 1, 1, 1]
        sizes = [[.1, .141], [.2,.272], [.37, .447], [.54, .619], [.71, .79], [.88, .961]]
        ...
        steps = []
        return locals()
    elif network=='shufflenet_g4':
        image_shape = '3,224,224'
        network = 'shufflenet_g4'
        from_layers = ['_plus9', '_plus12', '', '', '', '']
        num_filters = [-1, -1, 512, 256, 256, 128]
        strides = [-1, -1, 2, 2, 2, 2]
        pads = [-1, -1, 1, 1, 1, 1]
        sizes = [[.1, .141], [.2, .272], [.37, .447], [.54, .619], [.71, .79], [.88, .961]]
    ...
    elif network=='shufflenet_g1':
        
        image_shape = '3,224,224'
        
        network = 'shufflenet_g1'
        ...
        steps = []
        return locals()
    elif network=='shufflenet_g8':
        
        image_shape = '3,224,224'
        
        network = 'shufflenet_g8'
        ...
        image_shape = '3,224,224'
        from_layers = ['_plus11', 'Exit_flow_b6_sepconv2_relu' , '', '', '', '']
        num_filters = [-1, -1, 512, 256, 256, 128]
        strides = [-1, -1, 2, 2, 2, 2]
        pads = [-1, -1, 1, 1, 1, 1]
        sizes = [[.1, .141], [.2, .272], [.37, .447], [.54, .619], [.71, .79], [.88, .961]]
    ...
    elif network=='mobilenet_v2_05':
        image_shape = '3,224,224'
        network = 'mobilenet_v2_05'
        from_layers = ['relu6_1_expand', 'relu6_4', '', '', '', '']
        num_filters = [-1, -1, 512, 256, 256, 128]
        strides = [-1, -1, 2, 2, 2, 2]
        pads = [-1, -1, 1, 1, 1, 1]
        ...
        steps = []
        return locals()
    elif network=='mobilenet_v2_2':
        image_shape = '3,224,224'
        network = 'mobilenet_v2_2'
        from_layers = ['relu6_1_expand', 'relu6_4', '', '', '', '']
        num_filters = [-1, -1, 512, 256, 256, 128]
        strides = [-1, -1, 2, 2, 2, 2]
        pads = [-1, -1, 1, 1, 1, 1]
        ...
        steps = []
        return locals()
    elif network=='mobilenet_v2_15':
        image_shape = '3,224,224'
        network = 'mobilenet_v2_15'
        from_layers = ['relu6_1_expand', 'relu6_4', '', '', '', '']
        num_filters = [-1, -1, 512, 256, 256, 128]
        strides = [-1, -1, 2, 2, 2, 2]
        pads = [-1, -1, 1, 1, 1, 1]
        ...
        steps = []
        return locals()
    elif network=='mobilenet_v2_025':
        image_shape = '3,224,224'
        network = 'mobilenet_v2_025'
        from_layers = ['relu6_1_expand', 'relu6_4', '', '', '', '']
        num_filters = [-1, -1, 512, 256, 256, 128]
        strides = [-1, -1, 2, 2, 2, 2]
        pads = [-1, -1, 1, 1, 1, 1]
